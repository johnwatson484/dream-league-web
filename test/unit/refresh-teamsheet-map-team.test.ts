...
vi.mock('../../src/refresh/teamsheet/map-player.ts', () => ({
  mapPlayer: mockMapPlayer,
}))

vi.mock('../../src/refresh/teamsheet/map-position.ts', () => ({
  mapPosition: mockMapPosition,
}))

vi.mock('../../src/refresh/teamsheet/map-substitute.ts', () => ({
  mapSubstitute: mockMapSubstitute,
}))

import { mapTeam } from '../../src/refresh/teamsheet/map-team.ts'
